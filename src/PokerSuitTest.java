...
public class PokerSuitTest {
	...
	public void testRemoveonecard() {
		PokerSuit pokerSuit=new PokerSuit();
		pokerSuit.removeonecard();
		assertEquals(51, pokerSuit.getamount());
		pokerSuit.removeonecard();
		assertEquals(50, pokerSuit.getamount());
		//fail("Not yet implemented");
	}
