...
public class DNpokerTest {
   DNpoker dNpoker=new DNpoker();
	...
	public void testFindcow() {
		...
		Poker[] pokers0={new Poker(0,1),new Poker(1, 3),new Poker(2, 7),new Poker(3, 5),new Poker(0, 0)};
		Poker[] pokers1={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 5),new Poker(1, 4)};
		Poker[] pokers2={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 5),new Poker(1, 5)};
		Poker[] pokers3={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 5),new Poker(1, 6)};
		Poker[] pokers4={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 4),new Poker(1, 8)};
		Poker[] pokers5={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 8),new Poker(1, 5)};
		Poker[] pokers6={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 7),new Poker(1, 7)};
		Poker[] pokers7={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 7),new Poker(1, 8)};
		Poker[] pokers8={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 9),new Poker(1, 7)};
		Poker[] pokers9={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 9),new Poker(1, 8)};
		Poker[] pokers10={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 2),new Poker(1, 6)};
		Poker[] pokers11={new Poker(0,2),new Poker(1, 2),new Poker(2, 2),new Poker(3, 2),new Poker(1, 3)};
		Poker[] pokers12={new Poker(0,11),new Poker(1, 10),new Poker(2, 11),new Poker(3, 12),new Poker(0, 10)};
		Poker[] pokers13={new Poker(0,0),new Poker(1, 0),new Poker(2, 1),new Poker(3, 1),new Poker(1, 2)};
	...
	public void testCompare() {
		Poker[] pokers1={new Poker(2, 3),new Poker(2, 4),new Poker(2, 3),new Poker(2, 4),new Poker(3, 1)};
		Poker[] pokers2={new Poker(1, 3),new Poker(1, 6),new Poker(0, 5),new Poker(2, 3),new Poker(1, 2)};
		Poker[] pokers3={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 5),new Poker(1, 4)};
		Poker[] pokers4={new Poker(0,2),new Poker(1, 4),new Poker(2, 1),new Poker(3, 6),new Poker(1, 3)};
		DNpoker dNpoker1=new DNpoker();
		DNpoker dNpoker2=new DNpoker();
		DNpoker dNpoker3=new DNpoker();
		DNpoker dNpoker4=new DNpoker();
